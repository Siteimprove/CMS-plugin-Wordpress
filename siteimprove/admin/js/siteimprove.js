...
;(function ($) {
    ...
    const promise = new Promise(function (resolve, reject) {
      iframe.addEventListener(
        ...
        () => {
          ...
          var adminBar =
            iframe.contentWindow.document.getElementById('wpadminbar')
          if (adminBar) {
  ...
  window.siteimprove = {
    ...
    common: function (url) {
      ...
      if (this.method == 'recheck') {
        _si.push([this.method, this.url, this.token, this.callback])
        return
      }
  ...
  $(function () {
    ...
    if (typeof siteimprove_input !== 'undefined') {
      siteimprove.input(
        siteimprove_input.url,
        siteimprove_input.token,
        siteimprove_input.version,
        siteimprove_input.is_content_page,
        siteimprove_input.nonce
      )
    }
